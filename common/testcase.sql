...
INSERT INTO `testcase` VALUES (2, 'test_DLXSZH_002', '登录学生账号001', '/api/user/login', 'post', '{\'username\':\'niuhanyang\',\'passwd\':\'aA123456\'}', NULL, 'error_cod=0', '200', NULL);
INSERT INTO `testcase` VALUES (3, 'test_DLXSZH_003', '登录学生账号002', '/api/user/login', 'post', '{\'username\':\'admin\',\'passwd\':\'123456\'}', NULL, 'error_cod=500', '200', NULL);
...
-- ----------------------------
INSERT INTO `testcase_cjxm` VALUES (1, 'test_CJXM_001', '注册接口', '/api/user/user_reg', 'POST', '{\'username\':\'abctest\',\'pwd\':\'Aa123456\',\'cpwd\':\'Aa123456\'}', NULL, '{\'msg\':\'用户已存在\'}', '200', NULL);
INSERT INTO `testcase_cjxm` VALUES (2, 'test_CJXM_002', '登录', '/api/user/login', 'POST', '{\'userame\':\'mytest\',\'passwd\':\'Abc123\'}', NULL, '{\'error_code\':0}', '200', NULL);
INSERT INTO `testcase_cjxm` VALUES (3, 'test_CJXM_003', '添加奖品(需上传文件)', '/api/product/add', 'POST', '{\'userid\':\'78926\',\'sign\':\'b44109efbfe1007c1ad93a757d78e459\',\'name\':\'奖品名字2020\'}', NULL, '{\'msg\':\'必须是管理员才可以添加奖品\'}', '200', NULL);
INSERT INTO `testcase_cjxm` VALUES (4, 'test_CJXM_004', '抽奖接口', '/api/product/choice', 'GET', '{\'userid\':\'78926\',\'sign\':\'b44109efbfe1007c1ad93a757d78e459\'}', NULL, '{\'error_code\':0}', '200', NULL);
INSERT INTO `testcase_cjxm` VALUES (5, 'test_CJXM_005', '查看中奖记录', '/api/user/win_record', 'GET', '{\'userid\':\'78926\',\'sign\':\'b44109efbfe1007c1ad93a757d78e459\'}', NULL, '{\'error_code\':0}', '200', NULL);
...
INSERT INTO `testcase_ndxs` VALUES (2, 'test_NDXS_002', '登录', '/api/user/login', 'POST', '{\'userame\':\'mytest\',\'passwd\':\'Abc123\'}', NULL, '{\'error_code\':0}', NULL, NULL);
